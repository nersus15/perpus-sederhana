<?php
	...
	$kode = $_GET["kode"];
	$data = query("SELECT * FROM tblbuku WHERE kode = '$kode' ")[0];
	$judul = $data["judul"];
          ...
          <div class="row">
            <form class="form-horizontal" method="post" action="">
	            <div class="form-group row">
	              ...
	              <div class="col-sm-8">
	                <input id="kode" type="text" readonly class="form-control form-control-success" name="kode" value="<?= $kode; ?>" readonly>
	              </div>
	            </div>
	            <div class="form-group row">
	            ...
	            <div class="form-group row">
	              ...
	              <div class="col-sm-8">
	                <select class="form-control" autocomplete="off" name="jenis" id="jenis">
						<option <?php echo $jenis == 'Pendidikan' ? 'selected' : null ?> value="Pendidikan">Pendidikan</option>
						<option <?php echo $jenis == 'Hiburan' ? 'selected' : null ?> value="Hiburan">Hiburan</option>
						<option <?php echo $jenis == 'Komik' ? 'selected' : null ?> value="Komik">Komik</option>
					</select>
	              </div>
	            </div>
	            <div class="form-group row">
	            	<button type="Submit" name="submit" class="btn btn-primary">KONFIRMASI PERUBAHAN</button>
				</div>
				<div>
	            	<button type="reset" Onclick="window.history.back();" class="btn btn-primary">BATAL</button>
	            </div>
          	</form>
          </div>
        </div>
