              ...
              <tbody>
                ...
                foreach ($kueri as $data) : ?>
                  ...
                  <tr>
                    ...
                    <td><?= $jumlah; ?></td>
                    <td><?= $jenis; ?></td>
                    <td><a href="hapus.php?kode=<?= $kode; ?>" onclick="return confirm('Apakah data ini akan dihapus ?');">Hapus</a> | <a href="editbuku.php?kode=<?= $kode; ?>">Edit</a></td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
            </table>
