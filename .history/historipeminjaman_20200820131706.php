                      ...
                      <tbody>
                        <?php
						  ...
						  if($_SESSION['lvl'] == 'User'){
							   $kueri = query("SELECT tblpinjam.*, tblbuku.judul JOIN tblbuku ON tblbuku.kode = tblpinjam.buku FROM tblpinjam WHERE nama = '$namausernow' AND status = 'Diterima'");
						  } else{
							   $kueri = query("SELECT tblpinjam.*, tblbuku.judul JOIN tblbuku ON tblbuku.kode = tblpinjam.buku FROM tblpinjam WHERE status = 'Diterima'");
						  }
