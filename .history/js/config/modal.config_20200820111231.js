        ...
        opt: {
            ...
            modalBody: {
                input: [
                    ...
                    {
                        label:'<label for="jenis">Jenis Buku : </label>', type: 'custom', text: '<p><input type="checkbox" name="jenis" value="Pendidikan" /> Pendidikan </p>'
                    },
                    {
                        type: 'custom', text: '<p><input type="checkbox" name="jenis" value="Komik" /> Komik </p>'
                    }, 
                    {
                        type: 'custom', text: '<p><input type="checkbox" name="jenis" value="Hiburan" /> Hiburan </p>'
                    }
