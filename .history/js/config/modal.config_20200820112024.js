                ...
                input: [
                    ...
                    },
                    {
                        type: 'custom', text: '<label for="jenis">Jenis Buku : </label>' +
                          '<p><input type="radio" name="jenis" value="Pendidikan" /> Pendidikan </p>' +
                          '<p><input type="radio" name="jenis" value="Komik" /> Komik </p>' +
                          '<p><input type="radio" name="jenis" value="Hiburan" /> Hiburan </p>'
                    },
                    {
