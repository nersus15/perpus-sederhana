	            ...
	            <div class="form-group row">
	              ...
	              <div class="col-sm-8">
	                <select class="form-control" autocomplete="off" name="jenis" id="jenis">
						<option <?php $jenis == 'Pendidikan' ? 'selected' : null ?> value="Pendidikan">Pendidikan</option>
						<option <?php $jenis == 'Hiburan' ? 'selected' : null ?> value="Hiburan">Hiburan</option>
						<option <?php $jenis == 'Komik' ? 'selected' : null ?> value="Komik">Komik</option>
					</select>
	              </div>
	            </div>
	            <div class="form-group row">
