                      ...
                      <tbody>
                        <?php
						  ...
						  if($_SESSION['lvl'] == 'User'){
							   ...
							   $kueri = query("SELECT * FROM tblpinjam WHERE status = 'Diterima'");
						  }
                        ...
                        <?php foreach ( $kueri as $data ) : ?>
                          ...
                          <td><?= $status; ?></td>
						   <?php if ( $datauser["lvl"] === 'Admin' ) : ?>
						   <td>
						 <a href="?hapus=&id=<?= $id; ?>" onclick="return confirm('Apakah data ini akan dihapus ?');">Hapus</a>
                    </td>
					 <?php endif; ?>
                          </tr>
                        <?php endforeach; ?>
