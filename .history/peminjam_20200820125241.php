<?php
  ...
  $kueri = query("SELECT tblpinjam.*, tblbuku.judul FROM tblpinjam JOIN tblbuku ON tblpinjam.buku = tblbuku.kode  WHERE status='Dibaca' OR status='Pending' ORDER BY kode DESC ");
?>
<!DOCTYPE html>
<html>
  <head>
