<?php
  ...
  $kueri = query("SELECT tblrequestkembali.*, tblpinjam.buku, tblpinjam.nama, tblpinjam.tanggal, tbl.buku.judul FROM tblrequestkembali JOIN tblpinjam ON tblpinjam.kode = tblrequestkembali.pinjaman JOIN tblbuku ON tblbuku.kode = tblpinjam.buku ORDER BY kode DESC");
  var_dump($kueri);die;
  // Cek Tombol Search
  if ( isset($_GET["cari"]) ) {
