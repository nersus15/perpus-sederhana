<?php
  ...
  if($_SESSION['lvl'] == 'Admin')
    $daftaruser = query("SELECT * FROM tbluser");
  else
    $daftaruser = query("SELECT * FROM tbluser WHERE lvl='Admin'");
                ...
                <div class="card-body">
                  <form class="form-horizontal" action="" method="post" class="regi">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <label for="">Pilih penerima pesan</label>
                        <select name="penerima" class="form-control" id="">
                          <?php foreach($daftaruser as $u): ?>
                              <option value="<?php echo $u['username']?>"><?php echo $u['nama'] ?></option>
                            <?php endforeach?>
                        </select>
